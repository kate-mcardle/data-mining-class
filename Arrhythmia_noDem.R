...
hf = hf[,c("proc_p","los","charge","dnr","oprocs","odiags","oshpd_id")]
...
# LOS ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Convert training and test data to model matrices
x.los = model.matrix(~-1+dnr, data=los.train)
x.los = cbind(x.los, los.train$oprocs, los.train$odiags, los.train$size)
y.los = los.train$los
testx.los = model.matrix(~-1+dnr, data=los.test)
