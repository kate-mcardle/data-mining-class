...
hf = read.csv("by_diagnosis/prostate2009.txt", colClasses = "character")
hf = rbind(hf, read.csv("by_diagnosis/prostate2010.txt", colClasses = "character"))
hf = rbind(hf, read.csv("by_diagnosis/prostate2011.txt", colClasses = "character"))
